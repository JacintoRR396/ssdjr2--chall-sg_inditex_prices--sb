package com.ssdjr2.chall.sg.inditex_prices.exception;
...
public enum AppExceptionCodeEnum {
	...
	STATUS_40401( HttpStatus.NOT_FOUND, 40401, "Brand not Found" ),
	STATUS_40402( HttpStatus.NOT_FOUND, 40402, "Price not Found" ),
