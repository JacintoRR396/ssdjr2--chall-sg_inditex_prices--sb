...
public class PriceServiceImpl implements PriceService {
	...
	public PriceSearchResponseDTO search(PriceSearchQueryDTO body) {
		...
		Optional<PriceEntity> priceEntityOpt =
				this.priceRepository.findPriceByBrandIdAndProductIdAndApplicationDate(
				priceSearch.getBrandId(), priceSearch.getProductId(), priceSearch.getApplicationDates().getStartDate());
		...
		throw new PriceNotFoundException( priceSearch.getBrandId(), priceSearch.getProductId() );
	}
}
